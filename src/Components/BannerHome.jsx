                ...
                <div className="container mx-auto ">
                  <div className="w-full absolute bottom-0 max-w-md px-3">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <button onClick={()=>handleClick(data?.media_type,data?.id)}  className="bg-white px-4 py-2 text-black font-bold rounded mt-4 hover:bg-gradient-to-l from-red-500 to-orange-500 shadow-md transition-all hover:scale-105">Play now</button>
